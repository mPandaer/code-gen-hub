package com.pandaer.web.user.service.impl;
...
import com.pandaer.web.common.service.impl.EmailService;
...
import com.pandaer.web.user.entity.PasswordResetToken;
...
import static com.pandaer.web.common.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 发布一个用户活动事件 用户注册
            applicationEventPublisher.publishEvent(new UserActivityEvent(user.getId(), UserActivityTypeEnum.USER_REGISTER,this));
