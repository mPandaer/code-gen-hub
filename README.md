...
2. 我们制作好的代码生成器，存在一个参数控制一组参数的情况时，如果这个参数的输入不是最后一个，那么就会导致交互体验不是很好，如下图：
   ![image-20250123191928106](images/image-20250123191928106.png)

到此，整个代码生成器制作工具的全部逻辑都实现完成，接下来就是将代码生成器“云”化，即通过在线的方式使用我们的代码生成器。

## 阶段三   代码生成器制作工具云化

这一阶段，就是将阶段二制作好的代码生成器制作工具线上化，说的具体点就是为这个工具提供一个Web后端，Web前端，让用户可以更加友好的在线使用代码生成器，在线制作代码生成器，在线共享代码生成器。

这个阶段涉及到的功能如下：

1. 🍻 用户登录与注册 
2. 🍻管理员功能：用户管理，代码生成器管理
3. 🍻 代码生成器搜索 
4. 代码生成器详情查看
5. 代码生成器创建
6. 代码生成器下载
